...
功能：获取 ARK 基金持仓数据，支持自动分页
用法：python get_ark_fund_holding.py [--holding-type POSITION] [--cycle FIVE_DAY] [--sort-field SHARES] [--sort-dir 0] [--count 20] [--json]
...
HOLDING_TYPE_MAP = {
    "POSITION": futu.ArkHoldingType.POSITION,
    "INCREASE": futu.ArkHoldingType.INCREASE,
    "DECREASE": futu.ArkHoldingType.DECREASE,
    "NEW": futu.ArkHoldingType.NEW,
    "SOLD_OUT": futu.ArkHoldingType.SOLD_OUT,
}
...
SORT_FIELD_MAP = {
    "SHARES": futu.ArkFundHoldingSortField.SHARES,
    "WEIGHT_CHANGE": futu.ArkFundHoldingSortField.WEIGHT_CHANGE,
    "SHARES_CHANGE": futu.ArkFundHoldingSortField.SHARES_CHANGE,
    "MARKET_VALUE": futu.ArkFundHoldingSortField.MARKET_VALUE,
    "WEIGHT": futu.ArkFundHoldingSortField.WEIGHT,
}
...
def get_ark_fund_holding(holding_type=None, cycle=None, sort_field=None, sort_dir=0,
                          count=20, output_json=False, no_page=True):
    ...
    try:
        ...
        if output_json:
            ...
            print("=" * 70)
            print(f"ARK 基金持仓（共 {total_count} 条）")
            print("=" * 70)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="获取 ARK 基金持仓")
    ...
    parser.add_argument("--sort-dir", type=int, choices=[0, 1], default=0,
                        help="排序方向（0=降序，1=升序）")
    parser.add_argument("--count", type=int, default=20, help="每页返回数量")
    ...
    get_ark_fund_holding(holding_type=args.holding_type, cycle=args.cycle,
